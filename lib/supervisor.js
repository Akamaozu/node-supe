...
function supe( config ){
  ...
  // create supervisor interface
    ...
    public_interface.middleware = middleware;
  ...
  // load core modules
    public_interface.use( require( './modules/supervisor/citizen' ) );
  ...
  function start_citizen( name, file, params ){
    ...
    citizens[ name ] = middleware.run( 'citizen-starting', citizens[ name ] );
  ...
  function register_citizen( name, file, params ){
    ...
    // customize citizen instance
      citizens[ name ] = middleware.run( 'citizen-registration', citizens[ name ] );
